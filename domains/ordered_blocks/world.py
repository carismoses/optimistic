...
class OrderedBlocksWorldLearnedClass(OrderedBlocksWorldGT):
...
class OrderedBlocksWorldLearned(OrderedBlocksWorld):
    def __init__(self, num_blocks, model):
        super().__init__(num_blocks)
...
class OrderedBlocksWorldOpt(OrderedBlocksWorldGT):
    def __init__(self, num_blocks):
        super().__init__(num_blocks)
